...
// 			{
// 				if (isOpFloat(binOpArgs->op)) {
// //						VG_(printf)("1097 %.30lf,%.30lf,%.30lf\n", res->Org.fl,binOpArgs->orgFloat,mpfr_get_d(arg2tmpX,STD_RND)); 
// 						mpfr_set_flt(res->value, binOpArgs->orgFloat, STD_RND);
// 					} else {
// //						VG_(printf)("1100 %.30lf %.30lf, %30lf\n", res->Org.db,binOpArgs->orgDouble,mpfr_get_d(arg2tmpX,STD_RND)); 
